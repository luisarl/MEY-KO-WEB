          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              ...
              <div className="max-w-[600px] text-left">
                <p className="mb-5 text-base !leading-relaxed text-blue-900 dark:text-body-color-dark sm:text-lg md:text-xl">
                ...
                <div className="flex flex-col items-center justify-left space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    ...
                    className="rounded-sm bg-blue-900 px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
                    SOLICITAR MEMBRESIA
                  </Link>
                  {/* <Link
